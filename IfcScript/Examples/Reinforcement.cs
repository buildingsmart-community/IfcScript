	...
	internal class ReinfocingExample
	{
		internal static void GenerateData(STPModelData md, IfcBuilding building,bool assembly)
		{
			...
			if (assembly)
			{
				...
				IfcElementAssembly elementAssembly = new IfcElementAssembly(building, new IfcElemParams("0Q1tCJWdj4kOkZUg7rkf2h","","","",""), IfcAssemblyPlaceEnum.FACTORY, IfcElementAssemblyTypeEnum.REINFORCEMENT_UNIT);
