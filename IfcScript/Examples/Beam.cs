...
namespace IFC.Examples
{
	...
	internal abstract class Beam: IFCExampleBase
	{
		...
		{
			IfcElemParams elemParams = new IfcElemParams("","ExampleBeamName","ExampleBeamDescription","","Tag");
			if (tessellated)
			{
				List<Coord3d> coords = new List<Coord3d>() { new Coord3d(1000.0, 50.0, -91.5), new Coord3d(1000.0, 14.8, -91.5), new Coord3d(1000.0, 50.0, -100.0), new Coord3d(1000.0, -50.0, -100.0), new Coord3d(1000.0, -50.0, -91.5), new Coord3d(1000.0, -14.8, -91.5), new Coord3d(1000.0, -2.8, 79.5), new Coord3d(1000.0, -2.8, -79.5), new Coord3d(1000.0, -50.0, 91.5), new Coord3d(1000.0, -14.8, 91.5), new Coord3d(1000.0, -50.0, 100.0), new Coord3d(1000.0, 50.0, 100.0), new Coord3d(1000.0, 50.0, 91.5), new Coord3d(1000.0, 14.8, 91.5), new Coord3d(1000.0, 2.8, -79.5), new Coord3d(1000.0, 2.8, 79.5), new Coord3d(0.0, 2.8, 79.5), new Coord3d(0.0, 2.8, -79.5), new Coord3d(0.0, 50.0, 91.5), new Coord3d(0.0, 14.8, 91.5), new Coord3d(0.0, 50.0, 100.0), new Coord3d(0.0, -50.0, 100.0), new Coord3d(0.0, -50.0, 91.5), new Coord3d(0.0, -14.8, 91.5), new Coord3d(0.0, -2.8, -79.5), new Coord3d(0.0, -2.8, 79.5), new Coord3d(0.0, -50.0, -91.5), new Coord3d(0.0, -14.8, -91.5), new Coord3d(0.0, -50.0, -100.0), new Coord3d(0.0, 50.0, -100.0), new Coord3d(0.0, 50.0, -91.5), new Coord3d(0.0, 14.8, -91.5), new Coord3d(0.0, 14.8, -91.5), new Coord3d(0.0, 2.8, -79.5), new Coord3d(1000.0, 14.8, -91.5), new Coord3d(1000.0, 2.8, -79.5), new Coord3d(500.0, 2.8, -79.5), new Coord3d(500.0, 14.8, -91.5), new Coord3d(0.0, 2.8, -79.5), new Coord3d(0.0, 2.8, 79.5), new Coord3d(1000.0, 2.8, -79.5), new Coord3d(1000.0, 2.8, 79.5), new Coord3d(500.0, 2.8, -79.5), new Coord3d(500.0, 2.8, 79.5), new Coord3d(0.0, 2.8, 79.5), new Coord3d(0.0, 14.8, 91.5), new Coord3d(1000.0, 2.8, 79.5), new Coord3d(1000.0, 14.8, 91.5), new Coord3d(500.0, 2.8, 79.5), new Coord3d(500.0, 14.8, 91.5), new Coord3d(0.0, 14.8, 91.5), new Coord3d(0.0, 50.0, 91.5), new Coord3d(1000.0, 14.8, 91.5), new Coord3d(1000.0, 50.0, 91.5), new Coord3d(500.0, 14.8, 91.5), new Coord3d(500.0, 50.0, 91.5), new Coord3d(0.0, 50.0, 91.5), new Coord3d(0.0, 50.0, 100.0), new Coord3d(1000.0, 50.0, 91.5), new Coord3d(1000.0, 50.0, 100.0), new Coord3d(500.0, 50.0, 91.5), new Coord3d(500.0, 50.0, 100.0), new Coord3d(0.0, 50.0, 100.0), new Coord3d(0.0, -50.0, 100.0), new Coord3d(1000.0, 50.0, 100.0), new Coord3d(1000.0, -50.0, 100.0), new Coord3d(500.0, 50.0, 100.0), new Coord3d(500.0, -50.0, 100.0), new Coord3d(0.0, -50.0, 100.0), new Coord3d(0.0, -50.0, 91.5), new Coord3d(1000.0, -50.0, 100.0), new Coord3d(1000.0, -50.0, 91.5), new Coord3d(500.0, -50.0, 100.0), new Coord3d(500.0, -50.0, 91.5), new Coord3d(0.0, -50.0, 91.5), new Coord3d(0.0, -14.8, 91.5), new Coord3d(1000.0, -50.0, 91.5), new Coord3d(1000.0, -14.8, 91.5), new Coord3d(500.0, -50.0, 91.5), new Coord3d(500.0, -14.8, 91.5), new Coord3d(0.0, -14.8, 91.5), new Coord3d(0.0, -2.8, 79.5), new Coord3d(1000.0, -14.8, 91.5), new Coord3d(1000.0, -2.8, 79.5), new Coord3d(500.0, -14.8, 91.5), new Coord3d(500.0, -2.8, 79.5), new Coord3d(0.0, -2.8, 79.5), new Coord3d(0.0, -2.8, -79.5), new Coord3d(1000.0, -2.8, 79.5), new Coord3d(1000.0, -2.8, -79.5), new Coord3d(500.0, -2.8, 79.5), new Coord3d(500.0, -2.8, -79.5), new Coord3d(0.0, -2.8, -79.5), new Coord3d(0.0, -14.8, -91.5), new Coord3d(1000.0, -2.8, -79.5), new Coord3d(1000.0, -14.8, -91.5), new Coord3d(500.0, -2.8, -79.5), new Coord3d(500.0, -14.8, -91.5), new Coord3d(0.0, -14.8, -91.5), new Coord3d(0.0, -50.0, -91.5), new Coord3d(1000.0, -14.8, -91.5), new Coord3d(1000.0, -50.0, -91.5), new Coord3d(500.0, -14.8, -91.5), new Coord3d(500.0, -50.0, -91.5), new Coord3d(0.0, -50.0, -91.5), new Coord3d(0.0, -50.0, -100.0), new Coord3d(1000.0, -50.0, -91.5), new Coord3d(1000.0, -50.0, -100.0), new Coord3d(500.0, -50.0, -91.5), new Coord3d(500.0, -50.0, -100.0), new Coord3d(0.0, -50.0, -100.0), new Coord3d(0.0, 50.0, -100.0), new Coord3d(1000.0, -50.0, -100.0), new Coord3d(1000.0, 50.0, -100.0), new Coord3d(500.0, -50.0, -100.0), new Coord3d(500.0, 50.0, -100.0), new Coord3d(0.0, 50.0, -100.0), new Coord3d(0.0, 50.0, -91.5), new Coord3d(1000.0, 50.0, -100.0), new Coord3d(1000.0, 50.0, -91.5), new Coord3d(500.0, 50.0, -100.0), new Coord3d(500.0, 50.0, -91.5), new Coord3d(0.0, 50.0, -91.5), new Coord3d(0.0, 14.8, -91.5), new Coord3d(1000.0, 50.0, -91.5), new Coord3d(1000.0, 14.8, -91.5), new Coord3d(500.0, 50.0, -91.5), new Coord3d(500.0, 14.8, -91.5) };
				...
				triangulatedFaceSet.Comment = "the geometric representation of the beam is provided as a triangulated face set the meshing depends on the creating software system";
